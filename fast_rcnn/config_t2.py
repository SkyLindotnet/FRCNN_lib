...
__C.TRAIN.MULTI_SCALE_RPN_NUM = 2  # 2
...
# __C.TEST.Frozen_MIN_SIZE = 16  # 0.1
# proposal target like FC TEST
__C.TRAIN.Frozen_BATCH_SIZE = 128  # 16 32 64 128
__C.TRAIN.Frozen_FG_THRESH = 0.7  # 0.5 300w(0.7) fp3 hd1 hd1_2(0.5)
...
__C.TRAIN.MAP_offset = 1.3  # 50
# __C.TRAIN.MAP_offset_scale = 1.5
__C.TRAIN.MAP_SIZE = 120  # 90 120 28
if __C.TRAIN.PREDICE_KP_MAP:
    __C.TRAIN.Frozen_PRE_NMS_TOP_N = 300  # 300 6000
    __C.TRAIN.Frozen_POST_NMS_TOP_N = 100  # 300
    __C.TRAIN.Frozen_BATCH_SIZE = 16  # 128
...
if __C.TRAIN.KP == 1:
    ...
    __C.TRAIN.ATTRIBUTES = {'gt_keyPoints': 20}  # 10*2
elif __C.TRAIN.KP == 5:
