...
if __name__ == '__main__':
    ...
    for strategyThresh in np.arange(-0.20, -0.21, -0.01):
        for thresh in np.arange(20000, 30000, 10000):  # 0.1, 1, 0.1 100000, 0, -10000
            for scale in np.arange(500, 1100, 100):
                # region parameter initialization
                TrainingDB = 'wider_face'  # wider_face moon face_plus threeHusFace
                ...
                suffix = '_a_%d' % scale  # _Annotations_new_v2 _a_0_200_600 _p4_3
                ...
                # method = 'VGG16_faster_rcnn_end2end_with_fuse_multianchor_frozen_v2_5_lha_wfp1_2_s2_m0.5_2_1_iter_130000'
                ...
                # prototxt = 'VGG16/faster_rcnn_end2end/68_keyPoints/test_fuse_multianchor_frozen_v2_t1_s2.prototxt'
