...
def prepare_roidb(imdb):
    ...
    recorded.
    """
    if cfg.TRANSFORM_IMPATH_roid:
        sizes = []
        for i in xrange(imdb.num_images):
            new_path = transform_impath(imdb.image_path_at(i))
            sizes.append(PIL.Image.open(new_path).size)
    else:
